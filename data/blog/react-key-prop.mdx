...
You add a new task in your React to-do list…
and suddenly one of your input field jumps to a different item? 😅
...
**“Using the index as a key is fine.”**
❌ Not true - if your list changes (add, delete, reorder), the index isn't stable. React will mis-match items and cause UI bugs.

**“It works even without keys.”**
⚠️ React will fall back to using indexes as keys, but you might get weired bugs - expecially when your list has inputs, animations, or internal state.
...
* A **stable key** lets React reuse elements correctly and update only what’s needed.
